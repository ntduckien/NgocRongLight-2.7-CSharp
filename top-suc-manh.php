...
<html lang=vi>
   ...
   <script type=text/javascript>$(document).ready(function(){if($(window).width()<=500){$(".dashboard").addClass("menu-closed")}else{$(".dashboard").removeClass("menu-closed")}});</script>
   ...
   <body class=dashboard>
         ...
         <div class=container-fluid>
            ...
            <div class="collapse navbar-collapse" id=navbarSupportedContent>
               ...
               <ul class="navbar-nav ml-auto align-items-center">
                  ...
                  <div class=dropdown>
                     <a id="navbarDropdown dropdown-toggle" class="nav-link dropdown-toggle" href=# role=button data-toggle=dropdown aria-haspopup=true aria-expanded=false>
      ...
      <style>.center{margin-left:80px;margin-right:-250px}</style>
      <script type=text/javascript>$(document).ready(function(){$(".left-menu-btn-control").click(function(){$(".left-menu").toggleClass("menu-closed")})});</script>
                  ...
                  <div class="card-body d-flex justify-content-center w-100">
                     <table class="table table-bordered blueTable my-table center">
                        ...
                        <tbody>
                           <?php
                              $countTop = 1;
                              $data = mysqli_query($config, "SELECT `Name`, JSON_EXTRACT(InfoChar, '$.Power') AS CharPower FROM `character` WHERE (JSON_EXTRACT(InfoChar, '$.Power') > 0) ORDER BY CharPower DESC LIMIT 10; ");
                           ...
                           <tr class=top_<?php echo $countTop; ?>>
                              ...
                              <td>
                                 <?php echo htmlspecialchars($row['CharPower']); ?>
                              </td>
                           </tr>
                           <?php }
                              ?>
