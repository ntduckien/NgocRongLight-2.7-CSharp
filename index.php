...
<html lang="vi">
   ...
   <body class="dashboard">
      ...
      <div class="modal fade" id="thongbao" tabindex="-1" role="dialog" aria-labelledby="thongbaolable"
         aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <p><b style="color:red">Thông Báo : Chào Mừng Bạn Đến Với Trang Chủ Ngọc Rồng Light</b></p>
                  <b>
                     <p class="mb-0">UP Sét Kích Hoạt Hoàn Toàn Miễn Phí Và Nhanh Chóng</p>
                  </b>
                  <b>
                     <p class="mb-0" style="color:red">Nhóm Tin Tức Từ Đội Ngũ Admin Nro Light</p>
                  </b>
                  <b>
                     <p class="mb-0" style="color:red">Thân ái, Ngọc Rồng Light</p>
                  </b>
               </div>
      ...
      <script>$(document).ready(function () { $("#thongbao").modal("show"); $("#thongbao .close, #thongbao button[data-dismiss='modal']").click(function () { $("#thongbao").modal("hide") }); setTimeout(function () { $("#thongbao").modal("hide") }, 1000 * 60 * 120) });</script>
         ...
         <main>
            ...
            <div class="row g-4 py-4 row-cols-1 row-cols-md-4">
               ...
               <div class="col d-flex align-items-stretch">
                  <div class="feature-box">
                     ...
                     <br>
                     <div>
                        <a href="security.php" class="feature-title">Bảo Mật</a>
            ...
            <div class="alert alert-warning" style="background-color:#fdf8da">
               <div class="topic_name">
                  ...
                  <i class="fa fa-check-circle-o" aria-hidden="true" style="color:red"></i> <a id="modal-body">Nạp Thẻ
                  Tích Lũy
                  </a>
                  </b>
