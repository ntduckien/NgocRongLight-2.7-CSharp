...
$query = "SELECT COUNT(ban) AS ban FROM user WHERE ban = 1";
...
$query = "SELECT * FROM user WHERE ban = 1 AND username LIKE '%$searchValue%' LIMIT $offset, $pageSize";
$banned = mysqli_query($conn, $query);

$id_user = "SELECT COUNT(id) AS id FROM user";
...
$ban_total = "SELECT COUNT(ban) AS ban FROM user WHERE ban = 1";
...
$active_total = "SELECT COUNT(active) AS active FROM user WHERE active = 1";
